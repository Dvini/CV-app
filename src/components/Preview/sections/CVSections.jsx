...
export function SummarySection({ columnType }) {
  ...
  return (
    <div className="cv-section">
      {template === 'twocolumn' && (
        <h2 className={headingClass} style={{ color: themeColor }}>{t.summary}</h2>
      )}
...
export function SkillsSection() {
  ...
  return (
    <div className="cv-section">
      ...
      <ul className="cv-skills-list cv-breakable">
...
export function ProjectsSection({ columnType }) {
  ...
  return (
    <div className="cv-section">
      <h2 className={headingClass} style={{ color: themeColor }}>{t.projects}</h2>
      <div className="cv-items">
